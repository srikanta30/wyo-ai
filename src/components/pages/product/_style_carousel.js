...
const StyleCarousel = (prob) => {
    ...
    function setStyleList(allStyles) {
        ...
        allStyles.map((row, j) => {
            ...
            if(noneOpt){
                innerContent.push(
                    <div className="col-2 float-left" key={'col1'+j}>
                        <div className="carousel-box-container style-carousel" onClick={(e) => {activeSelectedStyle(e); prob.setStyle(null)}}>
                            <img className="carousel-img" src="no-style.jpeg" />
                            <div key="rands123" className="style-item">No Style</div>
                        </div>
            ...
            innerContent.push(
                <div className="col-2 float-left" key={'col2'+j}>
